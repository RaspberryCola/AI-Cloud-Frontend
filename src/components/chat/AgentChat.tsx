...
import { PlusIcon, SendIcon, TrashIcon, AlertCircleIcon, BotIcon, UserIcon, ChevronLeftIcon, ChevronRightIcon } from 'lucide-react';
    ...
    <div className="flex h-screen bg-background">
      ...
      >
        <div className="p-4 border-b flex justify-between items-center">
          <h2 className={`font-semibold text-lg ${isSidebarCollapsed ? 'hidden' : ''}`}>历史对话</h2>
